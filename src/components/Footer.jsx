...
const Footer = () => {
  return(
    <footer className="flex mt-auto flex-row justify-evenly md:justify-around items-center self-center h-16 w-11/12 md:w-8/12 gap-8 text-black rounded-lg bg-white select-none drop-shadow-xl">
