...
const Messages = () => {
  ...
  return(
    <main className="grid grid-row justify-items-center lg:self-center gap-2 m-5 text-white">
      <div className='flex flex-col items-center w-full sm:w-10/12 xl:w-11/12 hover:scale-100 transition duration-300 ease-in-out bg-black bg-opacity-25 backdrop-blur-xl p-5 m-5 rounded-lg text-sm sm:text-xl'>
