const Square = ({ children, updateBoard, index, title, imgURL }) => {
  ...
  return (
    <div className="w-full justify-center sm:w-10/12 xl:w-11/12 transition duration-300 justify-self-center ease-in-out bg-black bg-opacity-25 backdrop-blur-xl p-5 m-5 rounded-lg text-sm sm:text-xl">
