...
const Rules = () => {
  return(
    <main>
    <div className="flex flex-col justify-center content-center self-center items-center text-white gap-10 m-10 rounded-lg bg-black bg-opacity-25 backdrop-blur-xl w-11/12 p-10">
    ...
    <div className="flex flex-col justify-center content-center self-center items-center text-white text-xl gap-10 m-10 rounded-lg bg-black bg-opacity-25 backdrop-blur-xl w-11/12 p-10">
