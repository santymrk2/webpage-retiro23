const Square = ({ children, updateBoard, index, title, imgURL }) => {
  ...
  return (
    <div className="w-full justify-center  sm:w-8/12 hover:scale-100 transition duration-300 ease-in-out bg-black bg-opacity-25 backdrop-blur-xl p-5 m-5 rounded-lg text-sm sm:text-xl">
